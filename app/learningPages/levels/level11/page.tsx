// 3/4 time signature learning page
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            ...
            <div className="parent flex-parent">
                ...
                <div>
                    <p>This is the 3-4 time signature.</p>
                    <p>The numerator tells us there are 3 total beats in a measure, and the denominator tells us the quarter note will get the beat.</p>
                </div>
            </div>
            <h2>For example: </h2>
            <div className="flex items-center justify-center relative w-48 h-24">
            ...
            <p>We count this as “1 2 3”</p>
            <p>Here’s why:</p>
            <p>The quarter note gets the beat, since “4” is the denominator of our time signature. Each time we see a quarter note, we increment our count. There are 3 quarter notes allowed in a measure, since “3” is the numerator of our time signature</p>
            <div className="space-x-8">
                <Link href='/learningPages/levels/level10' className="bg-indigo-300 hover:bg-indigo-500 text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                    Back
                </Link>
